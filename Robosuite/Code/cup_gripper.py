"""
Gripper with two fingers for our own sawyer Robots.
"""
import numpy as np
...
class CupGripperBase(GripperModel):
    """
    Gripper with ice cream like scooper
    ...
    def __init__(self, idn=0):
        super().__init__(xml_path_completion("our_own.xml"), idn=idn)
...
class CupGripper(CupGripperBase):
    """
